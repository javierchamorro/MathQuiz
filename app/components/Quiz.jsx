...
export default class Quiz extends React.Component {
  ...
  onReset(correct){
    if(this.state.progresivo){
      ...
      let contadorCorrectas = this.state.contadorCorrectas;
      let contadorFalladas = this.state.contadorFalladas;
      if(correct){
    ...
    } else if(this.props.user_profile.learner_preference.difficulty === 9){
      this.setState({
        difficulty:Math.floor(Math.random() * 9),
      });
